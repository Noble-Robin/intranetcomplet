document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateTable() {
        ...
        fetch(`/moodle/api/courses/?${p.toString()}`)
            ...
            <td>
                <a href="/moodle/courses/edit/${c.id}/" class="btn btn-edit" title="Modifier le cours">
                ...
                <a href="/moodle/courses/delete/${c.id}/" class="btn btn-delete" title="Supprimer le cours" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce cours ?')">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
