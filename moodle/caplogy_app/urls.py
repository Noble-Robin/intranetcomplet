...
from .views_homepage import homepage
...
urlpatterns = [
    ...
    path('moodle/courses/edit/<int:course_id>/', views.create_course, name='edit_course'),
    path('moodle/courses/delete/<int:course_id>/', views.delete_course, name='delete_course'),
